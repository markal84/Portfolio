...
export const blogArticles = [
  ...
  },
  {
    ...
    desc: 'On the twenty-first day of developing the ProgressPal app, I encountered the difficulties of styling and implementing a good user interface (UI) and user experience (UX) without a clear conception of how the app would look from the beginning. This lack of initial vision made the process of designing and refining the UI/UX a challenging and time-consuming endeavor. Over the course of four days, I dedicated significant effort to styling the app, constantly iterating and adapting as my conceptions and styles evolved. This experience served as a valuable lesson, highlighting the importance of having a well-defined app conception before delving into the realm of UI/UX design.',
    summary:
